...
В рамках проекта также доступен современный прототип веб-приложения на Next.js, расположенный в `design/rpu-prj/`. Прототип включает:

- Полноценную структуру Next.js приложения с App Router
- React компоненты для отображения комиксов, серий, издателей
- Современный UI/UX дизайн
- TypeScript конфигурацию и зависимости

Подробная информация доступна в [docs/design-prototype.md](docs/design-prototype.md).
...
├── design/
│   └── rpu-prj/             # Next.js прототип современного веб-приложения
├── docs/                     # Документация
│   ├── target_schema.md     # Описание целевой схемы
│   └── design-prototype.md  # Информация о прототипе дизайна
